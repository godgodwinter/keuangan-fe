  ...
  <div class="flex justify-center w-full overflow-hidden">
    ...
    >
      <div
        ...
        style=""
      >
        <div class="relative flex items-center overflow-auto no-scrollbar">
          <ul class="flex items-center">
            <li>
              <a
                class="inline-flex items-center transition text-[15px] dark:hover:bg-solid-darkLighterBg sm:text-base m-0 sm:m-1 px-3 sm:px-4 py-3 rounded pointer-fine:hover:text-white pointer-fine:hover:bg-solid-medium whitespace-nowrap inactive"
                noscroll="true"
                href="/guides"
                ><span>Guides</span></a
              >
              ...
              <span class="flex lg:hidden"
                ...
                >
                  ...
                  >
                    ...
                    ></path></svg
                  ><span class="text-xs sr-only">Dark mode</span>
                </button></span
              >
            </li>
      ...
      <ul class="hidden lg:flex items-center">
        ...
        <li class="mx-2">
          <a rel="noopener" target="_blank" href="https://twitter.com/solid_js"
        ...
        >
          ...
          >
            <path
              ...
              d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z"
            ></path></svg
          ><span class="text-xs sr-only">Dark mode</span></button
        ><button
          aria-label="Select Language"
          class="dark:brightness-150 focus:color-red-500 bg-no-repeat bg-center bg-translate bg-24 hover:border-gray-500 cursor-pointer dark:border-gray-600 dark:hover:border-gray-500 px-6 pl-4 ml-2 rounded-md h-10 border border-solid-100 pt-4 text-sm my-3 w-full"
          type="button"
