...
<template>
  ...
  >
    ...
    <div class="pt-24">
      ...
      >
        ...
        <div class="w-full md:w-3/5 py-6 text-center">
          <img class="w-full md:w-4/5 z-50" src="@/assets/img/flat/hero.png" />
        </div>
      </div>
    </div>
    ...
    <div class="relative w-full max-w-xl">
      <div
        class="absolute top-0 -left-4 w-72 h-72 bg-purple-300 rounded-full opacity-70"
      ></div>
      <div
        class="absolute top-0 -right-4 w-72 h-72 bg-yellow-300 rounded-full opacity-70"
      ></div>
      <div
        class="absolute -bottom-8 left-20 w-72 h-72 bg-pink-300 rounded-full opacity-70"
      ></div>
      <div class="m-8 relative space-y-4 opacity-0">
        <div
          class="p-5 bg-white rounded-lg flex items-center justify-between space-x-8"
        >
          <div class="flex-1">
