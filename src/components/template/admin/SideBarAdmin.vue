    ...
    <ul class="menu p-4 overflow-y-auto w-80 bg-base-200 text-base-content">
      ...
      <!-- <li :class="[pagesActive == 'pemasukan' ? pagesActiveClass : '']">
        <router-link :to="{ name: 'AdminDashboard' }">
          ...
          <span class="ml-3">Pemasukan </span></router-link
        >
      </li>
      <li :class="[pagesActive == 'pengeluaran' ? pagesActiveClass : '']">
        <router-link :to="{ name: 'AdminDashboard' }">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-5 w-5"
      ...
      <li :class="[pagesActive == 'skills' ? pagesActiveClass : '']">
        <router-link :to="{ name: 'AdminSkills' }">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-5 w-5"
            viewBox="0 0 20 20"
          ...
          <span class="ml-3">Skills </span></router-link
        >
      </li>
      <li :class="[pagesActive == 'portofolios' ? pagesActiveClass : '']">
        <router-link :to="{ name: 'AdminPortofolios' }">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-5 w-5"
            viewBox="0 0 20 20"
          ...
          <span class="ml-3">Portofolios </span></router-link
        >
      </li>
      <li :class="[pagesActive == 'experiences' ? pagesActiveClass : '']">
        <router-link :to="{ name: 'AdminExperiences' }">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-5 w-5"
            viewBox="0 0 20 20"
          ...
          <span class="ml-3">Experiences </span></router-link
        >
      </li>
      <li :class="[pagesActive == 'achievements' ? pagesActiveClass : '']">
        <router-link :to="{ name: 'AdminAchievements' }">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-5 w-5"
            viewBox="0 0 20 20"
          ...
          <span class="ml-3">Achievements </span></router-link
        >
      </li>
      <li :class="[pagesActive == 'label' ? pagesActiveClass : '']">
        <router-link :to="{ name: 'AdminLabel' }">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-5 w-5"
            viewBox="0 0 20 20"
          ...
          <span class="ml-3">Label </span></router-link
        >
      </li>
      <li :class="[pagesActive == 'kategori' ? pagesActiveClass : '']">
        <router-link :to="{ name: 'AdminKategori' }">
      ...
      <li :class="[pagesActive == 'images' ? pagesActiveClass : '']">
        <router-link :to="{ name: 'AdminImages' }">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-5 w-5"
            viewBox="0 0 20 20"
          ...
          <span class="ml-3">Images </span></router-link
        >
      </li> -->
    </ul>
  </div>
